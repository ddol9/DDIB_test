package com.ddib.monolith.seat.websocket.config;

import com.ddib.monolith.seat.websocket.interceptor.SessionTrackingInterceptor;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureClientInboundChannel(ChannelRegistration registration) {
        registration.interceptors(sessionTrackingInterceptor);
    }
}
